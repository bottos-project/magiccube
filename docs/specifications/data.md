# Onchain BOT Data Model Specification
...
This document describes the serialization format for the data structures used in the Onchain BOT.
...
BOT is designed to support muti Ledger, but now is only allowed one ledger.
