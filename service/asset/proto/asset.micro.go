...
type AssetClient interface {
	...
	ModifyMyNoticeStatus(ctx context.Context, in *ModifyMyNoticeStatusRequest, opts ...client.CallOption) (*ModifyMyNoticeStatusResponse, error)
	GetUnreadNoticeNum(ctx context.Context, in *GetUnreadNoticeNumRequest, opts ...client.CallOption) (*GetUnreadNoticeNumResponse, error)
}
...
func (c *assetClient) ModifyMyNoticeStatus(ctx context.Context, in *ModifyMyNoticeStatusRequest, opts ...client.CallOption) (*ModifyMyNoticeStatusResponse, error) {
	req := c.c.NewRequest(c.serviceName, "Asset.ModifyMyNoticeStatus", in)
	out := new(ModifyMyNoticeStatusResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *assetClient) GetUnreadNoticeNum(ctx context.Context, in *GetUnreadNoticeNumRequest, opts ...client.CallOption) (*GetUnreadNoticeNumResponse, error) {
	req := c.c.NewRequest(c.serviceName, "Asset.GetUnreadNoticeNum", in)
	out := new(GetUnreadNoticeNumResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
type AssetHandler interface {
	...
	ModifyMyNoticeStatus(context.Context, *ModifyMyNoticeStatusRequest, *ModifyMyNoticeStatusResponse) error
	GetUnreadNoticeNum(context.Context, *GetUnreadNoticeNumRequest, *GetUnreadNoticeNumResponse) error
}
...
func (h *Asset) ModifyMyNoticeStatus(ctx context.Context, in *ModifyMyNoticeStatusRequest, out *ModifyMyNoticeStatusResponse) error {
	return h.AssetHandler.ModifyMyNoticeStatus(ctx, in, out)
}

func (h *Asset) GetUnreadNoticeNum(ctx context.Context, in *GetUnreadNoticeNumRequest, out *GetUnreadNoticeNumResponse) error {
	return h.AssetHandler.GetUnreadNoticeNum(ctx, in, out)
}
