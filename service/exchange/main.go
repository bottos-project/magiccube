...
const (
	GET_INFO_URL         = config.BASE_URL + "v1/chain/get_info"
	GET_BLOCK_URL        = config.BASE_URL + "v1/chain/get_block"
	ABI_JSON_TO_BIN_URL  = config.BASE_URL + "v1/chain/abi_json_to_bin"
	ABI_BIN_TO_JSON_URL  = config.BASE_URL + "v1/chain/abi_bin_to_json"
	PUSH_TRANSACTION_URL = config.BASE_URL + "v1/chain/push_transaction"
	GET_TABLE_ROW        = config.BASE_URL + "v1/chain/get_table_row_by_string_key"
