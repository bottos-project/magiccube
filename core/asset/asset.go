...
//BOT is planed to support UTXO and Balance
const (
	Balance AssetRecordType = 0x00
	UTXO    AssetRecordType = 0x01
)

//define the asset stucture in BOT
